                   ...
                   <div class="row">
                        ...
                        {{-- <h6>Keputusan</h6> --}}
                            <div class="card mt-3">
                                ...
                                <li class="list-group-item text-start"><i>Status :</i> <b class="badge bg-warning p-2">Pending</b></li>
                            ...
                            if($jum == 0) {
                             ?>
                             <button class="btn btn-success px-4 mt-3" data-bs-toggle="modal" data-bs-target="#exampleModal">VALIDASI</button>
                             <?php  
                         } else {
