                        ...
                        <div class="card">
                            ...
                            @foreach($survey as $s)
                                ...
                                <center>
                                    ...
                                    <a href="{{url('/hapus-photo-survey/'.$s->survey_id.'/'.$u->mustahik_id)}}" class="btn btn-danger px-4 my-3" onclick="return confirm('Apakah anda yakin ingin menghapus photo ini?');">Hapus Photo</a>
                                </center>
                                @endforeach
                            </li>
                            @else
...
<div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <form action="{{url('/simpan-survey')}}" method="POST" enctype="multipart/form-data">
        @csrf
        @foreach($mustahik as $u)
        <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Dokumentasi Survey</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                <div class="form-group">
                    <label for="">Nama Petugas Survey</label>
                    <input type="text" class="form-control" name="petugas_survey">
                </div>
                <div class="form-group">
